---
permalink: /
title: "Quantum information for quantum technology"
author_profile: true
redirect_from:
  - /about/
  - /about.html
...
I am a tenure-track scientist at the [Paul Scherrer Institute](https://www.psi.ch/en), working at the interface of quantum information theory, many-body physics, and quantum computation and simulation.
...
**I am currently looking for PhD students and postdocs — see [Opportunities](/opportunities/).**
...
<!-- Keep News short (3–5 most recent items). When it grows past ~5, move older items to a dedicated /news page. -->

## News

- *May 2026* — Our QuantERA grant *Digital-analog methods in quantum simulation has been approved*. Together with Monika Aidelsburger (LMU Munich), Daniel González-Cuadra (UAM Madrid), Philipp Preiss (MPQ), and Alexander Schuckert (ENS Paris), we will develop digital-analog approaches to quantum simulation, in particular for neutral atom devices.
...
- *Jan 2026* — Our paper [*Optimal randomized measurements for a family of non-linear quantum properties*](https://doi.org/10.1103/PRXQuantum.7.010360) was published in *PRX Quantum*. Joint work with Zhenyu Du, Yifan Tang, Ingo Roth, Jens Eisert, and Zhenhuan Liu.
